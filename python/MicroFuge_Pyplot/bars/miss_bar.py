...
p6 = plt.bar(ind[:2] + width * 6,  mean_values, width, color='w', yerr=stderr_values,
...
p7 = plt.bar(ind[:2] + width * 7,  mean_values, width, color='w', yerr=stderr_values,
...
plt.legend((p0[0], p1[0], p2[0], p3[0], p4[0], p5[0], p6[0], p7[0]),
           ('Storage System', 'Memcached',
            'DLC', 'DLC + DLS', "DLC + DLS + AC",
            "Overall Rejection Rate", 'DLC with 10% Write', 'DLS with 10% Write'),
