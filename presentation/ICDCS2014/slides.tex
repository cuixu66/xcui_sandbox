...
\begin{frame}
  ...
  \item Possible solutions to performance isolation.
    ...
    \item Meet clients' response time requirements in the shared environment.
      \myv
    \item We represent response time requirements with request deadlines.
      \myv
...
\begin{frame}
  \frametitle{Deadline-Aware Caching with DLC vs Memcached}
  \begin{figure}[t]
    \begin{center}
...
\begin{frame}
  \frametitle{Deadline-Aware Caching with DLC and DLS vs Memcached}
  \begin{figure}[t]
    \begin{center}
