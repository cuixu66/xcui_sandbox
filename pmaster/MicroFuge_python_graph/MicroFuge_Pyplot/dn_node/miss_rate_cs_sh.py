...
plt.axhline(y=sh_overall, linestyle='--', color='r', label="Overall Dealine Miss Rate DLC + DLS")
plt.axhline(y=cs_overall, linestyle=':', color='k', label="Overall Deadline Miss Rate DLC")
# plt.legend()
